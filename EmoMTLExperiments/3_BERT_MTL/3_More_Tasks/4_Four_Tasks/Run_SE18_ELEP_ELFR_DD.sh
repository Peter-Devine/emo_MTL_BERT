...
#$ -N MTL_4_tasks_SE18_ELEP_ELFR_DD
...
/usr/bin/time --verbose python $1/EmoMTLExperiments/3_BERT_MTL/1_MTL_Tasks/TrainAndEvalMTL.py --max_seq_length=100 --batch_size=32 --data_path=$1/EmoMTLExperiments/1_Datasets/1_Create_datasets/data/ --task_list=SE18,ELEPContext,ELFRContext,DDContext --results_output=$1/EmoMTLExperiments/3_BERT_MTL/3_More_Tasks/4_Four_Tasks/SE18_ELEP_ELFR_DD_results --model_name=SE18_ELEP_ELFR_DD --num_pretraining_epochs=25 --num_finetune_epochs=5
