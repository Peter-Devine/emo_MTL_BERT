...
/usr/bin/time --verbose python $1/EmoMTLExperiments/3_BERT_MTL/2_Zero_Shot_Tests/ZeroShotTest.py --max_seq_length=100 --batch_size=32 --data_path=$1/EmoMTLExperiments/1_Datasets/1_Create_datasets/data/ --task_list=ELFRContext,SE19Context --results_output=$1/EmoMTLExperiments/3_BERT_MTL/1_MTL_Tasks/5_Score_Models/2_Two_Tasks_Evaluation/ELFR_SE19/results_ELFR --target_task=ELFRContext --inference_task=ELFRContext --model_path=$1/EmoMTLExperiments/3_BERT_MTL/1_MTL_Tasks/5_Score_Models/2_Two_Tasks_Evaluation/ELFR_SE19/ELFR/model_state_dict.pkl --label_map_path=$1/EmoMTLExperiments/3_BERT_MTL/1_MTL_Tasks/5_Score_Models/2_Two_Tasks_Evaluation/ELFR_SE19/ELFR/label_map_collection.out
