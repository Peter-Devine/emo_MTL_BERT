...
/usr/bin/time --verbose python $1/EmoMTLExperiments/3_BERT_MTL/2_Zero_Shot_Tests/ZeroShotTest.py --max_seq_length=100 --batch_size=32 --data_path=$1/EmoMTLExperiments/1_Datasets/1_Create_datasets/data/ --task_list=DDContext --results_output=$1/EmoMTLExperiments/3_BERT_MTL/2_Zero_Shot_Tests/DD/results_DD --target_task=SE19Context --inference_task=DDContext --emotions_map=0!others,1!angry,2!others,3!others,4!happy,5!sad,6!others --model_path=$1/EmoMTLExperiments/3_BERT_MTL/2_Zero_Shot_Tests/DD/model_state_dict.pkl --label_map_path=$1/EmoMTLExperiments/3_BERT_MTL/2_Zero_Shot_Tests/DD/label_map_collection.out
