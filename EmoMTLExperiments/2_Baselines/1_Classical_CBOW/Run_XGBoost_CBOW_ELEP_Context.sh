...
/usr/bin/time --verbose python $1/EmoMTLExperiments/2_Baselines/1_Classical_CBOW/XGBoost_CBOW_Baseline.py --x_column=utterance --y_column=emotion --context_column=context --data_path=$1/EmoMTLExperiments/1_Datasets/1_Create_datasets/data/EmotionLinesEmotionPush/ --output_path=$1/EmoMTLExperiments/2_Baselines/1_Classical_CBOW/ELEP_Context_results --word_vector_txt_path=$1/EmoMTLExperiments/2_Baselines/1_Classical_CBOW/word_vectors/glove.6B.300d.txt
